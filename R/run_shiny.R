...
run_cbammr_app <- function(launch.browser = TRUE, port = NULL, host = "127.0.0.1") {
  ...
  message("Version: 8.2.0")
  message("")
  message("Features:")
  message("  ✓ Interactive data upload & examples")
  message("  ✓ Complete meta-analysis with all modern methods")
  message("  ✓ Distribution-free methods (permutation, bootstrap, quantile)")
  message("  ✓ Clinical decision tools (EVPI, decision curves, NNT)")
  message("  ✓ Bayesian methods (bootstrap, meta-regression)")
  message("  ✓ Sensitivity analysis suite with robustness scoring")
  message("  ✓ Professional visualizations for all methods")
  message("  ✓ GRADE evidence assessment & fragility index")
